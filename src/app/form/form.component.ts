...
export class FormComponent implements OnInit {
  ...
  constructor(private formService:FormService,private router:Router,  private mesgService: MessageService
    ) { }

  ngOnInit() {
    this.dropdownOptions = [...this.dropdownOptions, {charityId: 1, description:'NSPCC', logoFileName: 'nspcc', charityName:'NSPCC',purpose:'Child protection',registrationId:'12345678'},
                            {charityId: 2, description:'Cancer Research UK', logoFileName: 'cruk', charityName:'Cancer Research UK',purpose:'Cancer Research and prevention',registrationId:'12312433'},
                            {charityId: 3, description:'Cancer Research Wales', logoFileName: 'crw', charityName:'Cancer Research Wales',purpose:'Cancer Research and prevention',registrationId:'12279188'},
                            {charityId: 4, description:'Amnesty International', logoFileName: 'amnesty', charityName:'Amnesty International',purpose:'Human Rights Upkeep',registrationId:'12245943'},
                            {charityId: 5, description:'Cancer Scotland', logoFileName: 'cancer_scotland', charityName:'Cancer Scotland',purpose:'Cancer Research and prevention',registrationId:'0'},
